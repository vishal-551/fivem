...
client_scripts { 'client/dependencies.lua', 'modules/notify.lua', 'modules/callback_client.lua', 'client/entities.lua', 'client/animation.lua', 'client/camera.lua', 'client/weather.lua', 'client/appearance.lua', 'client/projects.lua', 'client/main.lua' }
